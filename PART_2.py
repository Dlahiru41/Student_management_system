...
values=list(database2.values())#take the values of database2 to a list seperately
list1=list(values)
list2=list(database2.values())


#___________Verticle Histrogram____________
if lowerPossition=='s':#only works in the staff version
    maximum = max(list1)
    print('Progress  Trailing  Retriever  Excluded')
    for i in range(maximum):#....program will iterate range(maximum) times
        list1[0]-=1
        list1[1]-=1
        list1[2]-=1
        list1[3]-=1
        if list1[0]>=0:
            print('*'.center(10),end='')#by the center(10) the '*' will print midle of 10 characters (----*-----)
        else:
            print(' '.center(10),end='')
        if list1[1]>=0:
            print('*'.center(10),end='')
        ...
        if list1[3]>=0:
            ...
            print(' '.center(10))
    print(str(list2[0]).center(9),str(list2[1]).center(9),str(list2[2]).center(10),str(list2[3]).center(7))
print('Outcomes in total ',sum(list2))
